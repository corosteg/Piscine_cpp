...
void            FragTrap::meleeAttack(std::string const & target) const {
    std::cout << "FR4G-TP ( soldier ) " << this->_name << " attacks " << target << " at melee, causing " << this->_meleeAttackDamage << " points of damage !" << std::endl;
}

void            FragTrap::takeDamage(unsigned int amount) {
    std::cout << "FR4G-TP ( soldier ) " << this->_name << " received " << amount << " damage " << std::endl;
    while(amount > 0)
    {
    ...
    std::cout << "FR4G-TP ( soldier )" << this->_name << " have now " << this->_armorDamageReduction << " armor and " << this->_hitPoints << " hit points" << std::endl;
...
void            FragTrap::beRepaired(unsigned int amount) {
    std::cout << "FR4G-TP ( soldier )" << this->_name << " was repareid and received " << amount << " hit points " << std::endl;
    while(amount > 0)
    {
    ...
    std::cout << "FR4G-TP ( soldier )" << this->_name << " have now " << this->_hitPoints << " hit points " << std::endl;
}
